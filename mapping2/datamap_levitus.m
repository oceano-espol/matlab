...
else; coastmap_levitus(v,'nofill',dxdy); dx = abs(dx); dy = abs(dy); 
end
...
% hold on, contour(x_cont,y_cont,c_cont,'k-'),

% Plot the land mask
if maplast == 1; hold on; coastmap_levitus(v,1,1); else; coastmap_levitus(v,'nofill',dxdy); end
