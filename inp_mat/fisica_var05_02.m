...
fisica_2var05=fisica_vc06;
fisica_2var05=[fisica_2var05(:,1),fisica_2var05(:,2),fisica_2var05(:,3),fisica_2var05(:,5),fisica_2var05(:,4)];
...
figure(1); subplot(3,1,1); % Esmeraldas - Salinidad
...
hold on; [c1,c2]=contour(x_out,y_out,c,'k');clabel(c1,c2,'fontweight','bold');set(c2,'linewidth',1);
% plot(esmeraldas(:,2),esmeraldas(:,3),'k+','markersize',3);
%%%%%%%% isolinea de 26.5 %%%%%%%%%%%%%%
[zz2,h2]=contour(x_out,y_out,c,[-32.5 32.5],'k');
clabel(zz2,h2,'fontweight','bold'),set(h2,'linewidth',1)
%%%%%%%%% %%%%%%%%%%%%%%%% %%%%%%%%%%%%
set(gca,'xtick',[1:1:18]);
set(gca,'xticklabel','JUL|AGO|SEP|OCT|NOV|DEC|ENE|FEB|MAR|ABR|MAY|JUN|JUL|AGO|SEPT|OCT|NOV|DIC');
...
subplot(3,1,2); % Puerto Lopez - Salinidad
...
%%%%%%%% isolinea de 26.5 %%%%%%%%%%%%%%
[zz2,h2]=contour(x_out,y_out,c,[-34.2 34.2],'k');
clabel(zz2,h2,'fontweight','bold'),set(h2,'linewidth',1)
%%%%%%%% isolinea de 27 %%%%%%%%%%%%%%
[zz2,h2]=contour(x_out,y_out,c,[-34.4 34.4],'k');
clabel(zz2,h2,'fontweight','bold'),set(h2,'linewidth',1)
%%%%%%%% isolinea de 26.5 %%%%%%%%%%%%%%
[zz2,h2]=contour(x_out,y_out,c,[-34.6 34.6],'k');
clabel(zz2,h2,'fontweight','bold'),set(h2,'linewidth',1)
%%%%%%%% isolinea de 27 %%%%%%%%%%%%%%
[zz2,h2]=contour(x_out,y_out,c,[-34.8 34.8],'k');
clabel(zz2,h2,'fontweight','bold'),set(h2,'linewidth',1)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
set(gca,'xtick',[1:1:18]);
set(gca,'xticklabel','JUL|AGO|SEP|OCT|NOV|DEC|ENE|FEB|MAR|ABR|MAY|JUN|JUL|AGO|SEPT|OCT|NOV|DIC');
...
subplot(3,1,3); % Salinas - Salinidad
...
figure(2); subplot(3,1,1); % Esmeraldas - Temperatura
...
% plot(esmeraldas(:,2),esmeraldas(:,3),'k+','markersize',3);
%%%%%%%% isolinea de 26.5 %%%%%%%%%%%%%%
[zz2,h2]=contour(x_out,y_out,c,[-26.5 26.5],'k');
clabel(zz2,h2,'fontweight','bold'),set(h2,'linewidth',1)
%%%%%%%%% %%%%%%%%%%%%%%%% %%%%%%%%%%%%
%%%%%%%% isolinea de 27 %%%%%%%%%%%%%%
[zz2,h2]=contour(x_out,y_out,c,[-27 27],'k');
clabel(zz2,h2,'fontweight','bold'),set(h2,'linewidth',1)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
set(gca,'xtick',[1:1:18]);
set(gca,'xticklabel','JUL|AGO|SEP|OCT|NOV|DEC|ENE|FEB|MAR|ABR|MAY|JUN|JUL|AGO|SEPT|OCT|NOV|DIC');
...
subplot(3,1,2); % Puerto Lopez - Temperatura
...
% plot(p_lopez(:,2),p_lopez(:,3),'k+','markersize',3);
%%%%%%%% isolinea de 273 %%%%%%%%%%%%%%
[zz2,h2]=contour(x_out,y_out,c,[-23 23],'k');
clabel(zz2,h2,'fontweight','bold'),set(h2,'linewidth',1)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
set(gca,'xtick',[1:1:18]);
set(gca,'xticklabel','JUL|AGO|SEP|OCT|NOV|DEC|ENE|FEB|MAR|ABR|MAY|JUN|JUL|AGO|SEPT|OCT|NOV|DIC');
...
subplot(3,1,3); % Salinas - Temperatura
