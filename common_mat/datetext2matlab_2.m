function answ321=datetext2matlab_2(data_in)
% function answ321=datetext2matlab_2(data_in)
%
% PRUEBA!!!
...
for i=1:length(data_in(:,1)),
    ...
    date_num(i,:)=datenum([dm_date(i,3),dm_date(i,1),dm_date(i,2),...
...
julian_fact=1721059;
answ321=[date_num,date_num+julian_fact,dm_date(:,3),dm_date(:,1),dm_date(:,2),dm_hour];
